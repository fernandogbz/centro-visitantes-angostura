...
const Reservar = () => {
  ...
  const validarPaso2 = () => {
    if (esInstitucion && !formData.institucion.trim()) {
      toast({
        title: "Error",
        description: "Ingresa el nombre de la institución",
        variant: "destructive",
      });
      return false;
    }
    if (!formData.numVisitantes || parseInt(formData.numVisitantes) < 1) {
      toast({
        title: "Error",
        description: "Ingresa un número válido de visitantes",
        variant: "destructive",
      });
      return false;
    }
    if (!formData.arboretum) {
      toast({
        title: "Error",
        description: "Indica si visitarás el Arboretum",
        variant: "destructive",
      });
      return false;
    }
    if (!formData.nombreContacto.trim()) {
      toast({
        title: "Error",
        description: "Ingresa el nombre del contacto",
        variant: "destructive",
      });
      return false;
    }
    if (!formData.telefono.match(/^\+56\d{9}$/)) {
      toast({
        title: "Error",
        description: "Formato de teléfono inválido (+56XXXXXXXXX)",
        variant: "destructive",
      });
      return false;
    }
              ...
              <div className="flex items-center space-x-4">
                <div
                  className={`flex items-center space-x-2 ${
                    paso === 1 ? "text-primary" : "text-muted-foreground"
                  }`}
                >
                  <div
                ...
                <div
                  className={`flex items-center space-x-2 ${
                    paso === 2 ? "text-primary" : "text-muted-foreground"
                  }`}
                >
                  <div
                    className={`w-8 h-8 rounded-full flex items-center justify-center font-bold ${
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) =>
                        setEsInstitucion(checked as boolean)
                      }
                    />
                ...
                <div>
                  ...
                  <RadioGroup
                    value={formData.arboretum}
                    onValueChange={(value) =>
                      handleInputChange("arboretum", value)
                    }
                  >
                ...
                <div className="flex items-start space-x-2 pt-4">
                  ...
                  >
                    ...
                    privacidad del Centro de Visitantes Angostura del Biobío
                  </Label>
                </div>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="grid md:grid-cols-2 gap-4 text-left">
                  ...
                  <div className="p-4 border rounded-lg">
                    ...
                    <div className="font-semibold">
                      {formData.numVisitantes} personas
                    </div>
                  </div>
                  <div className="p-4 border rounded-lg">
                    <div className="text-sm text-muted-foreground mb-1">
                ...
                <div className="bg-secondary/10 p-4 rounded-lg text-sm">
                  <p className="text-muted-foreground">
                    ...
                    <strong>{formData.email}</strong> con los detalles de tu
                    visita e indicaciones de cómo llegar.
                  </p>
                </div>
